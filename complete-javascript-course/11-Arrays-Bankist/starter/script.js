...
// console.log(dogs.flatMap((dog) => dog.owners).includes('Sarah'))

// 2.
// The find method returns the first element for which the condition is true
// const dogSarah = dogs.find(dog => dog.owners.includes('Sarah'))
// console.log(dogSarah)

// dogs.map(dog => {
//  if (dog.owners.includes('Sarah')){
//   // console.log(dog.curFood > dog.recommendedFood ? "Sarah's dog is eating too much" : 'Dog is eating ok')
//  }
// } )
...
//  dog.curFood >= 0.1 * recommendedFood || dog.curFood <= 0.1 * dog.recommendedFood
// const checkEAtingOkay = dogs.some(dog => dog.curFood > 0.9 * dog.recommendedFood && dog.curFood < 1.1 * dog.recommendedFood)

// // 7. Create an array containing the dogs that are eating an OKAY amount of food (try to reuse the condition used in 6.)

// const okFood = dogs.filter(dog => dog.curFood > 0.9 * dog.recommendedFood && dog.curFood < 1.1 * dog.recommendedFood)
// console.log(okFood)
...
// const sortPortion = dogs.slice().sort((a,b) => a.recommendedFood - b.recommendedFood)
